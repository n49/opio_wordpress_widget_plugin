...
<div class="widget-body carousel">
    <div class="slider-container testimonial-slider carousel">
    <?php
        ...
        if (!is_wp_error($api_response) && $api_response['response']['code'] === 200) {
            ...
            foreach (array_slice($filteredReviews, 0, 9) as $review) {
                ?>
                <div class="testimonial-slide review-tile">
                    ...
                    <?php if (strlen($review['content']) > 100) { ?>
                        <?php echo esc_attr(mb_substr($review['content'], 0, 126, 'UTF-8')); ?>...<u>Read more</u>
                    <?php } else { ?>
    ...
    <div style="display: flex;background: #ffffff;height: 300px;align-items: flex-start;justify-content: center;gap: 10px;flex-direction: column; padding-right: 30px; margin-top: -20px;">
        <div style="display: flex;align-items: center;margin-left: 7px;">
            <span id="powered-by-text" style="font-size: 12px;">Powered by</span><div style="background-image: url(&quot;https://op.io/dashboard/graphics/opio-blue-new-1x.png&quot;); display: flex; align-items: center; min-width: 100px; min-height: 35px; background-size: contain; background-position: center center; background-repeat: no-repeat;"></div>
        </div>
        <div style="display: flex; flex-direction: column;">
            <div style="display: flex;">
                <div style="overflow: hidden; position: relative;">
                    ...
                    <?php if($business['aggregateRating'][3]['average'] > 0.5) { ?>
                        <div style="position: relative; overflow: hidden; cursor: pointer; display: block; float: left; width:22px; height: 22px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.04 22.83"><defs><style>.str-1{fill: #ffc600;}</style></defs><title>yellow</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="str-1" d="M12,18.36l7.43,4.48-2-8.44L24,8.71,15.39,8,12,0,8.64,8,0,8.71l6.55,5.68-2,8.44Zm0,0"/></g></g></svg></div>
                    <?php } else if($business['aggregateRating'][3]['average'] == 0.5) { ?>
                        <div style="position: relative; overflow: hidden; cursor: pointer; display: block; float: left; width:22px; height: 22px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.04 22.83"><defs><style>.str-2{fill:#E6E8EB;}.str-1{fill: #ffc600;}</style></defs><title>yellow-grey</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="str-2" d="M12,18.36l7.43,4.48-2-8.44L24,8.71,15.39,8,12,0m0,18.36"/><path class="str-1" d="M12,0,8.64,8,0,8.71l6.55,5.68-2,8.44L12,18.36m0,0"/></g></g></svg></div>
                    <?php } else { ?>
                        <div style="position: relative; overflow: hidden; cursor: pointer; display: block; float: left; width:22px; height: 22px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.04 22.83"><defs><style>.str0-1{fill:#E6E8EB;}</style></defs><title>grey</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="str0-1" d="M12,18.36l7.43,4.48-2-8.44L24,8.71,15.39,8,12,0,8.64,8,0,8.71l6.55,5.68-2,8.44Zm0,0"/></g></g></svg></div>
                    <?php } ?>
                ...
                <div style="display: flex; margin-left: 5px;"><span style="display: flex; margin-top: -6px; font-size: 24px; font-weight: 700;"><?php echo esc_attr($business['aggregateRating']['3']['average']); ?>/5</span></div>
            </div>
            <div style="display: flex;margin-top: -8px;text-align: center;justify-content: center;">
