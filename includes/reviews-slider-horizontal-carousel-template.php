                    ...
                    <div style="vertical-align: top;">
                        <div class="avatar-container">
                            ...
                            <?php } else if($review['propertyInfo']['name'] === 'yelp') { ?>
                                <div class="c-yelp-logo" style="background-image: url(&quot;<?php echo esc_url(OPIO_ASSETS_URL) . 'img/yelp-logo.png'; ?>&quot;);"></div>
                            <?php } else if($review['propertyInfo']['name'] === 'Trip Advisor') { ?>
                                <div class="c-tripadvisor-logo" style="background-image: url(&quot;<?php echo esc_url(OPIO_ASSETS_URL) . 'img/tripadvisor-logo.png'; ?>&quot;);"></div>
                            <?php } else { ?>
...
<script>
    ...
    var opio_slider_c_jq = jQuery.noConflict();
