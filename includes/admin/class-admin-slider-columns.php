...
class Admin_Slider_Columns {
    ...
    public function change_edit_post_link($link, $id, $context) {
        if (function_exists('get_current_screen')) {
            ...
            return admin_url('admin.php?page=grw-slider&' . Post_Types::SLIDER_POST_TYPE . '_id=' . $id);
        } else {
            return;
        }
    }
    ...
    public function get_columns($columns) {
        ...
        $columns = array(
            ...
            'grw_theme' => __('Review Type', 'slider-widget-for-opio-reviews'),
            'grw_status' => __('Status', 'slider-widget-for-opio-reviews'),
