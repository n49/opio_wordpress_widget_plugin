...
class Admin_Feed_Columns {
    ...
    public function change_edit_post_link($link, $id, $context) {
        if (function_exists('get_current_screen')) {
            ...
            return admin_url('admin.php?page=opio-builder&' . Post_Types::FEED_POST_TYPE . '_id=' . $id);
        } else {
            return;
        }
    }
    ...
    public function get_columns($columns) {
        ...
        $columns = array(
            ...
            'title'     => __('Title', 'widget-for-opio-reviews'),
            'ID'        => __('ID',    'widget-for-opio-reviews'),
            'opio_theme' => __('Review Type', 'widget-for-opio-reviews'),
            'opio_status' => __('Status', 'widget-for-opio-reviews'),
            'date'      => __('Date',  'widget-for-opio-reviews'),
        );
        return $columns;
    }
