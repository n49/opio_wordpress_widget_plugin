...
class Admin_Tophead {
    ...
    public function render() {
        ...
        if (strpos($current_screen->id, 'opio') !== false) {
            ...
            ?>
            <div class="opio-tophead">
                <div class="opio-tophead-title">
                    <!--span class="opio-tophead-logo" style="position: relative; margin-right: 10px; vertical-align: middle">
                    ...
                    <img src="<?php echo esc_url(OPIO_ASSETS_URL . 'img/logo.jpeg') ?>" alt="logo">
                    OPIO Reviews
                </div>
                <span class="opio-version">OPIO Plugin Version: <?php echo esc_attr(OPIO_PLUGIN_VERSION); ?></span>
            </div>
            <?php
        }
    }
