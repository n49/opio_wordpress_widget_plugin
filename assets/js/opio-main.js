...
function addReview(rev, index, reviewFeedUrl, business) {
    ...
    if(rev.propertyInfo.name === 'facebook') {
        ...
        if(rev.rating > 0) {
            reviewBuilder += `<div style="position: relative; overflow: hidden; cursor: pointer; display: block; float: left; width:16px; height: 22px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.04 22.83"><defs><style>.str-1{fill: <?php echo $starColor ?>;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="str-1" d="M12,18.36l7.43,4.48-2-8.44L24,8.71,15.39,8,12,0,8.64,8,0,8.71l6.55,5.68-2,8.44Zm0,0"/></g></g></svg></div>`;
